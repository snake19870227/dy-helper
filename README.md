# Java实现的某音爬虫
首先使用 Charles、Fiddler 等抓包工具获取手机APP的http请求头、cookie信息，类似:[https://raw.githubusercontent.com/snake19870227/dy-helper/master/doc/WX20200226-201819%402x.png](抓包截图)  
